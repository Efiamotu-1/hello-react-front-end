...
https://github.com/Efiamotu-1/hello-rails-backend
...
#### Github
- Enter this url: [https://github.com/Efiamotu-1/hello-react-front-end](https://github.com/Efiamotu-1/hello-react-front-end) in your web browser.
...
```sh
  git clone https://github.com/Efiamotu-1/hello-react-front-end.git
```
